  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-2xl p-4 md:px-8 shadow-input bg-white/80 dark:bg-slate-900/50">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          className="bg-gradient-to-br relative group/btn from-black dark:from-slate-800 dark:to-slate-800 to-neutral-600 block dark:bg-slate-800 w-full text-white rounded-md h-10 font-medium"
          type="submit"
        >
          Send Message &rarr;
          <BottomGradient />
